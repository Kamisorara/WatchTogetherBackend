...
CREATE TABLE `sys_role`  (
  ...
  `role_name` varbinary(20) NOT NULL COMMENT '角色名',
...
CREATE TABLE `sys_user`  (
  ...
  `user_nick_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户昵称',
